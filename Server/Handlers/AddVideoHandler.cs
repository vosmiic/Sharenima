...
public class AddVideoHandler : AuthorizationHandler<AddVideoRequirement> {
    ...
    protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, AddVideoRequirement requirement) =>
